    ...
    <div onClick={(e) => {
      ...
      <AlertDialog.Root>
        <AlertDialog.Trigger asChild>
          <Button variant="outline" className="flex items-center gap-2 m-auto mt-6"><TrashIcon /> Delete Recipe</Button>
        </AlertDialog.Trigger>
        <AlertDialog.Portal>
          ...
          <div className="p-4 fixed z-50 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full flex justify-center items-center">
            <AlertDialog.Content className="w-[95vw] max-w-xl rounded-lg p-4 md:w-full max-h-full overflow-aut bg-white dark:bg-gray-800">
              <AlertDialog.Title className="font-display text-primary text-2xl font-semibold mb-3">Are you sure you want to delete this recipe?</AlertDialog.Title>
