...
function Page() {
  ...
  return (
    <div className="m-auto max-w-3xl p-4 md:p-8">
      <h1 className="font-display text-3xl mb-3 text-brand-alt flex">
        <SparklesIcon className="w-6 mr-3" />
        Support the developer
      </h1>
      <p className="mb-4">Reciparse is a development project by <Link className={linkClasses} href="https://nickvanmeter.com/" target="_blank">Nick VanMeter</Link>. It was created mostly to demonstrate my skills and technical abilities (and a little bit because I enjoy cooking, and reading recipes online has turned into a real pain in the butt).</p>
      <p className="mb-4">Reciparse is built on <Link className={linkClasses} href="https://react.dev/" target="_blank">React</Link>/
        ...
        <Link className={linkClasses} href="https://tailwindcss.com/" target="_blank">Tailwind</Link>, and served to you via{' '}
