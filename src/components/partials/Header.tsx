...
export default function Header({
  ...
  return (
    <header className={classnames('sticky print:static top-0 z-10 relative isolate bg-white', withBorder && 'border-b-slate-100 print:shadow-none shadow-sm print:border-none border-b', className)}>
