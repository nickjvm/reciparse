...
export default function CookieBanner() {
  ...
  return (
    <div className={classNames('z-[100000] rounded-lg p-3 ring-2 ring-brand-alt fixed bottom-2 -translate-x-[50%] left-[50%] w-[90%] max-w-full md:max-w-2xl bg-white shadow', pathname === '/recipe' && 'bottom-16')}>
